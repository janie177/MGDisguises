...
public class DisguiseCommand implements CommandExecutor
{
    ...
    private static final List<EntityType> defaultAllowed = Lists.newArrayList(EntityType.CHICKEN, EntityType.SQUID, EntityType.SKELETON, EntityType.ENDERMAN, EntityType.CREEPER, EntityType.RABBIT, EntityType.HORSE, EntityType.SHEEP, EntityType.COW, EntityType.PIG, EntityType.GUARDIAN, EntityType.SPIDER, EntityType.CAVE_SPIDER, EntityType.SLIME, EntityType.MAGMA_CUBE, EntityType.BLAZE, EntityType.GHAST, EntityType.PIG_ZOMBIE, EntityType.SILVERFISH, EntityType.VILLAGER, EntityType.OCELOT, EntityType.WOLF, EntityType.SNOWMAN, EntityType.IRON_GOLEM, EntityType.BAT, EntityType.ENDERMITE, EntityType.WITCH, EntityType.MUSHROOM_COW, EntityType.SHULKER, EntityType.POLAR_BEAR);
